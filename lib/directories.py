...
map_template_filename = '{}/templates/map_equation_template.cpp'.format(module_directory)
function_template_filename = '{}/templates/function_template.cpp'.format(module_directory)
