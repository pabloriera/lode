...
void rk4($Ode_name* unit)
{
    ...
    //   derivsRK   Right hand side of the $Ode_name; derivsRK is the
...
static void ${Ode_name}_next_a($Ode_name *unit, int inNumSamples);
static void ${Ode_name}_next_k($Ode_name *unit, int inNumSamples);
static void ${Ode_name}_Ctor($Ode_name* unit);
static void ${Ode_name}_Dtor($Ode_name* unit);
...
void ${Ode_name}_Ctor($Ode_name* unit)
{
    printf("${Ode_name} v0.2\n");
    printf("SAMPLEDUR %g\n",SAMPLEDUR);
    printf("mBufLength %d\n",unit->mBufLength );
    ...
    unit->N_EQ = $N_EQ;
    unit->N_PARAMETERS = $N_PARAMETERS;
    ...
    // ${Ode_name}_next_k(unit, 1);
}

void ${Ode_name}_Dtor($Ode_name* unit)
{
...
void ${Ode_name}_next_a($Ode_name *unit, int inNumSamples)
{
...
void ${Ode_name}_next_k($Ode_name *unit, int inNumSamples)
{
